def MainFileGUI(ProjectName,LayuppNumber,TimeStamp,Angle):
    print()
    print('--------Running MainFileGUI--------')
    ...
    Options =  DataFrame(Option, columns = ['ProjectName','LayuppNumber','TimeStamp','Angle'])
    print(Options)
